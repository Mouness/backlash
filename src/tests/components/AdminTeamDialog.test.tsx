...
describe('AdminTeamDialog', () => {
  ...
  it('renders correctly for new member', () => {
    render(<AdminTeamDialog open={true} onClose={mockOnClose} onSave={mockOnSave} />);
  ...
  it('submits valid data', async () => {
    ...
    fireEvent.change(screen.getByLabelText(/admin.common.name/i), {
  ...
  it('submits valid data with photo', async () => {
    ...
    fireEvent.change(screen.getByRole('textbox', { name: /admin.common.name/i }), {
      target: { value: 'John Doe' },
    });
